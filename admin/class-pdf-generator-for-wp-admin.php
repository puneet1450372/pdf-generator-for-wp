...
class Pdf_Generator_For_Wp_Admin {
	...
	public function pgfw_admin_body_settings_page( $pgfw_body_html_arr ) {
		...
		$pgfw_body_html_arr   = array(
			...
			array(
				'title'       => __( 'Select Villa Type ', 'pdf-generator-for-wp' ),
				'type'        => 'select',
				'description' => __( 'You can choose your villa type ( branded or unbranded )', 'pdf-generator-for-wp' ),
				'id'          => 'pgfw_body_villa_type',
				'value'       => $pgfw_body_villa_type,
				'class'       => 'pgfw_body_villa_type',
				'name'        => 'pgfw_body_villa_type',
				'options'     => array(
					'branded'          => __( 'Branded', 'pdf-generator-for-wp' ),
					'unbranded'        => __( 'Unbranded', 'pdf-generator-for-wp' ),
